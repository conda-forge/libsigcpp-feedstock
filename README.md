...
<table><tr>
    ...
    <td>
      <a href="https://app.travis-ci.com/conda-forge/libsigcpp-feedstock">
        <img alt="linux" src="https://img.shields.io/travis/com/conda-forge/libsigcpp-feedstock/master.svg?label=Linux">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=568&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/libsigcpp-feedstock?branchName=master&jobName=win&configuration=win_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `libsigcpp, sigcpp-2.0` can be installed with `conda`:
...
```
mamba install libsigcpp sigcpp-2.0
```
